	...
	<head>
		...
		$(function(){
			...
			$("#faqUpdateBtn").click(function(){
				goUrl = "/faq/faqupdateForm"
				$("#fqq_data").attr("action", goUrl);
				$("#fqq_data").submit();
			});
	...
	<body>
		...
		<form name="faq_data" id="faq_data" method="post">
			...
			<div class="btnArea col-md-4 text-right">
				...
				<input type="button" id="faqDeleteBtn" class="btn btn-primary btn-sm"  value="삭제" />	
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>${detail.faq_num} (조회수:${detail.faq_readcnt})</td>
