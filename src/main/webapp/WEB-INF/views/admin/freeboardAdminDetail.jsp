    ...
    <div id="content_wrap">
		...
		<form id="detail">
			<table summary="게시판 상세 페이지" class="table" border="0">
				<tr>
					<th>글 번 호</th>
					<td>${adetail.fb_num}</td>
					<th class="th_date">작 성 일</th>
					<td>${adetail.fb_writeday}</td>
				</tr>
				
				<tr>
					<th>조회수:</th>
					<td>${adetail.fb_readcnt}</td>
				</tr>
				
				<tr>
					<th>글 제 목</th>
					<td colspan="3">${adetail.fb_title}</td>
				</tr>
				<tr>
					<th>작 성 자</th>
					<td colspan="3">${adetail.fb_author}</td>
				</tr>
				<tr>
					<th>글 내 용</th>
					<td colspan="3">${adetail.fb_content}</td>
				</tr>
