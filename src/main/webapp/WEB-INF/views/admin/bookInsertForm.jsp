					...
					<table class="table table-condensed">
						...
						<tr>
							...
							<td>
								...
								<input type="date" name="b_date" id="b_date" value=''/>
							</td>
							<td>
								<label for="b_price">가격</label>
								<input type="number" name="b_price" id="b_price" value=""/>
							</td>
						</tr>
						<tr>
							<td></td>
							<td><label for="b_title">작가</label></td>
							<td><input type="text" id="b_author" name="b_author" class="form-control" value=''/></td>
							<td><label for="b_pub" class="text-right">출판사</label></td>
							<td><input type="text" id="b_pub" name="b_pub" class="form-control" value=""/></td>
						</tr>
						<tr>
							<td colspan="1"><label for="b_name">책제목</label></td>
							<td class="text-left" colspan="4"><input type="text" id="b_name" name="b_name" class="form-control" value="" /></td>
						</tr>
						<tr>
							<td><label for="b_content">목차</label></td>
							<td colspan="4"><textarea name="b_list" id="b_list" cols="30" rows="10" class="form-control" rows="8"></textarea></td>
						</tr>
						<tr>
							<td><label for="b_content">책 소개</label></td>
							<td colspan="4"><textarea name="b_info" id="b_info" cols="30" rows="10" class="form-control" rows="8"></textarea></td>
						</tr>
						<tr>
							<td><label for="b_content">저자 소개</label></td>
							<td colspan="4"><textarea name="b_authorinfo" id="b_authorinfo" cols="30" rows="10" class="form-control" rows="8"></textarea></td>
						</tr>
						<tr>
							<td>
								미니 커버 사진(listcover)
